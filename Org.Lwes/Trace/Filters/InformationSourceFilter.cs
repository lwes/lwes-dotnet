...
namespace Org.Lwes.Trace.Filters
{
	...
	internal class InformationSourceFilter : ITraceSourceFilter
	{
		#region Fields
		...
		internal InformationSourceFilter(TraceSource source)
		{
		...
		internal InformationSourceFilter(string sourceName)
		{
